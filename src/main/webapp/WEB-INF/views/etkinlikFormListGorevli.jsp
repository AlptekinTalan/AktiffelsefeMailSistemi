				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:input cssClass="form-control" path="etkinlikAdi"
							value="${etkinlikObject.etkinlikAdi}" readonly="true" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:input type="text" cssClass="form-control"
							...
							value="${etkinlikObject.etkinlikTarihi}" readonly="true" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:input cssClass="form-control" path="etkinlikSaati"
							value="${etkinlikObject.etkinlikSaati}" readonly="true" />
					</div>
				</div>
			</div>
		</div>
			...
			<h6>
				<c:if test="${empty uyeListe}">
					<div class="alert alert-danger">
						...
						<strong>Etkinlik İçin Görevli Bulunamadı :(((</strong>
					</div>
				</c:if>
				<table class="table table-hover table-bordered">
					...
					<tbody>
						<c:forEach items="${uyeListe}" var="mus" varStatus="status">
							<tr>
								<th><c:out value="${gorevliListe[status.index].gorevliId}" /></th>
								...
								<th><a
									href="removeGorevliFromEtkinlik?gorevliId=<c:out value='${gorevliListe[status.index].gorevliId}'/>&etkinlikId=<c:out value='${etkinlikObject.etkinlikId}'/>">Çıkar</a></th>

							</tr>
						</c:forEach>
						<tr>
							<th><a
								href="listAllUyeForEtkinlikGorevli?etkinlikId=<c:out value='${etkinlikObject.etkinlikId}'/>">EKLE</a></th>
							<th></th>
							<th></th>
							<th></th>
							<th></th>
