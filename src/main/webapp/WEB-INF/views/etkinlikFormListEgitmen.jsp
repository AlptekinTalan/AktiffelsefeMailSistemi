					...
					<tbody>
						<c:forEach items="${uyeListe}" var="mus" varStatus="status">
							<tr>
								...
								<th><a
									href="removeEgitmenFromEtkinlik?egitmenId=<c:out value='${egitmenListe[status.index].egitmenId}'/>&etkinlikId=<c:out value='${etkinlikObject.etkinlikId}'/>">Çıkar</a></th>

							</tr>
						</c:forEach>
						<tr>
							<th><a
								href="listAllUyeForEtkinlikEgitmen?etkinlikId=<c:out value='${etkinlikObject.etkinlikId}'/>">EKLE</a></th>
							<th></th>
							<th></th>
							<th></th>
							<th></th>
