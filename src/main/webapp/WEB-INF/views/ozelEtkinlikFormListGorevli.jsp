					...
					<tbody>
						<c:forEach items="${uyeListe}" var="mus" varStatus="status">
							<tr>
								...
								<th><a
									href="removeGorevliFromOzelEtkinlik?gorevliId=<c:out value='${gorevliListe[status.index].gorevliId}'/>&etkinlikId=<c:out value='${ozelEtkinlikObject.etkinlikId}'/>">Çıkar</a></th>

							</tr>
						</c:forEach>
						<tr>
							<th><a
								href="listAllUyeForOzelEtkinlikGorevli?etkinlikId=<c:out value='${ozelEtkinlikObject.etkinlikId}'/>">EKLE</a></th>
							<th><a
