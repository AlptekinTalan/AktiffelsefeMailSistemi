														...
														<tbody>
															<tr>
																<td class="mcnImageContent" valign="top"
																	...
																	src="http://35.157.242.234/resources/photos/aktiffelsefe.png"
																	width="264"
																	style="max-width: 264px; padding-bottom: 0; display: inline !important; vertical-align: bottom; border: 0; height: auto; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
																	class="mcnImage">
														...
														<tbody>
															<tr>
																...
																<td valign="top" class="mcnTextContent"
																	...
																	<h2
																		style="display: block; margin: 0; padding: 0; color: #222222; font-family: Helvetica; font-size: 34px; font-style: normal; font-weight: bold; line-height: 150%; letter-spacing: normal; text-align: left;">Yeni
																		Yüksektepe Nedir?</h2>

																	<p
																		style="margin: 10px 0; padding: 0; mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #808080; font-family: Helvetica; font-size: 16px; line-height: 150%; text-align: left;">Yeni
																		Yüksektepe Kültür Derneği, 1989 yılında Ankara'da
																		kurulmuş, etkinliklerini kendi ilkeleri doğrultusunda
																		gerçekleştiren, kar amacı gütmeyen, siyasi ve dini bir
																		nitelik taşımayan felsefi-kültürel bir harekettir. 12
																		ilde toplam 18 şubesi bulunmaktadır.</p>

																	<p
																		style="margin: 10px 0; padding: 0; mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #808080; font-family: Helvetica; font-size: 16px; line-height: 150%; text-align: left;">Kurulduğu
																		günden beri bireyin ve toplumun gelişimi için "Daha
																		iyi, güzel ve adil bir dünya" vizyonuyla binlerce
																		kültürel, sosyal ve felsefi etkinlik
																		gerçekleştirmiştir. Ve tüm bu faaliyetler üyeler
																		tarafından gönüllülük ilkesiyle hayata
																		geçirilmektedir.</p>

																	<p
																		style="margin: 10px 0; padding: 0; mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #808080; font-family: Helvetica; font-size: 16px; line-height: 150%; text-align: left;">İsmimizdeki
																		"yüksektepe" ifadesi, her insanın içinde var olan
																		manevi değerlerin bulunduğu yüksek bir tepeyi
																		simgeler. Yüce, kirli olmayan, saf olan şeyleri
																		anlatır. Hemen hemen tüm büyük uygarlıklar ve
																		kültürler, en yüce amaçlarını, ideallerini yüksek
																		tepelerin ve dağların zirvelerine yerleştirmişlerdir.
																		Kutsal dağ, evrensel arketip daima mevcut olmuştur:
																		Hintlilerin Meru Dağı, İslam kültürünün Kaf Dağı,
																		İnkaların Machu Pichu Dağı ve İyonların Akropolleri
																		gibi...</p>
																																		...
																																		<tbody>
																																			<tr>
																																				...
																																				<td align="center" valign="middle"
																																					...
																																					style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
																																					<a
																																					href="https://www.facebook.com/aktiffelsefeyeniyuksektepe/"
																																					target="_blank"
																																		...
																																		<tbody>
																																			<tr>
																																				...
																																				<td align="center" valign="middle"
																																					...
																																					style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
																																					<a
																																					href="https://twitter.com/aktif_felsefe"
																																					target="_blank"
																																					style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"><img
																																		...
																																		<tbody>
																																			<tr>
																																				...
																																				<td align="center" valign="middle"
																																					...
																																					style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
																																					<a
																																					href="http://www.aktiffelsefe.org/"
																																					target="_blank"
																																					style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"><img
														...
														<tbody>
															<tr>
																...
																<td valign="top" class="mcnTextContent"
																	...
																	<em>Copyright © 2017 Aktiffelsefe, Tüm hakları
																		saklıdır.</em><br> <br> <br> <strong>Email
																		adresimiz: info@aktiffelsefe.org</strong><br> <br>
																	Adres: Hoşdere Cad. Fuar Sk. No:11/13
																</td>
															</tr>
														</tbody>
													</table> <!--[if mso]>
